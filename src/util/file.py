...
def _define_paths(base_path):
    global BASE_DIR, DATA_DIR, MRMS_RALA_DIR, MRMS_CGFLASH_DIR, MRMS_NLDN_DIR, \
           ...
           MRMS_PRECIPRATE_DIR, MRMS_PROBSEVERE_DIR, MRMS_FLASH_DIR, MRMS_VIL_DIR, MRMS_DVIL_DIR, \
           ...
           RAP_DIR, MRMS_NWS_RAW_DIR, MRMS_NWS_DIR, NWS_REGISTRY_PATH, STORMCELL_DIR, METAR_DIR, CELL_DIR, SURFACE_DIR
