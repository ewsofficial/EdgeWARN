...
def _define_paths(base_path):
    global BASE_DIR, DATA_DIR, MRMS_RALA_DIR, MRMS_CGFLASH_DIR, MRMS_NLDN_DIR, \
           ...
           RAP_DIR, MRMS_NWS_RAW_DIR, MRMS_NWS_DIR, MRMS_NWS_IDS_DIR, MRMS_NWS_TS_DIR, NWS_REGISTRY_PATH, STORMCELL_DIR, METAR_DIR, CELL_DIR, SURFACE_DIR, ALERTS_DIR, EDGEWARN_ALERTS_DIR, EDGEWARN_ALERTS_IDS_DIR, EDGEWARN_ALERTS_TS_DIR, \
    ...
    MRMS_NWS_IDS_DIR = MRMS_NWS_DIR / "ids"
    MRMS_NWS_TS_DIR = MRMS_NWS_DIR / "timestamps"
